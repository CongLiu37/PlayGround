...
start = time.time()
main.run_trimmomatic(file1=home+"raw_data/"+args[1]+"_1.fq.gz",file2=home+"raw_data/"+args[1]+"_2.fq.gz",clean1=home+"clean_data/"+args[1]+"_1.fq.gz",clean2=home+"clean_data/"+args[1]+"_2.fq.gz",unpaired1=home+"clean_data/unpaired_"+args[1]+"_1.fq.gz",unpaired2=home+"clean_data/unpaired_"+args[1]+"_2.fq.gz",adaptor=home+"NexteraPE-PE.fa",threads=args[2])
end = time.time()
